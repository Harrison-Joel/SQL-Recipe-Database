...
def searchRecipeRunAll():
    ...
    def decrementRecipeCounter(recipes):
        global recipeCounter
        print("recipeCounter=", recipeCounter)
        if(recipeCounter-2 >= 0):
            ...
            tkinter.messagebox.showinfo("First recipe","No previous recipes")
